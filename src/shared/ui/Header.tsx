...
const Header = () => {
  ...
  return (
    <header className="flex w-full min-h-15 border-b border-black/40 bg-white justify-between items-center px-[15%] relative">
      ...
      <div
        className="flex border border-black/40 h-10 w-10 rounded-full bg-linear-to-br from-amber-600 via-orange-600 to-red-600 text-white font-semibold text-xl items-center justify-center absolute right-48 cursor-pointer"
        role="button"
