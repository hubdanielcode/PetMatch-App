...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-amber-100 via-orange-100 to-red-100 dark:bg-linear-to-br dark:from-amber-900/90 dark:via-orange-900/90 dark:to-red-900/90 px-4 sm:px-6 py-8 sm:py-12">
