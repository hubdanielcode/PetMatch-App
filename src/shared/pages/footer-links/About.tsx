...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-amber-100 via-orange-100 to-red-100 px-4 sm:px-6 py-8 sm:py-12">
      <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black mb-3 leading-tight">
          Sobre o{" "}
      ...
      <div className="max-w-5xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-black/40">
