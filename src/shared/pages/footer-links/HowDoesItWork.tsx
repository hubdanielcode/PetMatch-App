...
const HowDoesItWork = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-amber-100 via-orange-100 to-red-100 px-4 sm:px-6 py-10 sm:py-16">
      <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black mb-3 sm:mb-4">
          Como Funciona
        </h1>

        <p className="text-sm sm:text-base text-black/70 px-2 sm:px-0">
            ...
            return (
              ...
              >
                ...
                <div className="w-full md:w-1/2">
                  <div className="bg-white rounded-xl p-4 sm:p-6 shadow-md border border-black/40 hover:shadow-xl transition">
      ...
      <div className="max-w-xl mx-auto mt-14 sm:mt-20 text-center px-2">
        ...
        <button
          className="bg-linear-to-br border border-black/40 from-amber-600 via-orange-600 to-red-600 hover:from-amber-400 hover:via-orange-400 hover:to-red-400 text-white px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl font-semibold transition cursor-pointer text-sm sm:text-base"
