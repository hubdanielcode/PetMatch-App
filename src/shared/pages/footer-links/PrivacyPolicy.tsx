...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-amber-100 via-orange-100 to-red-100 px-4 sm:px-6 py-8 sm:py-12 font-sans text-black/90">
      ...
      <section className="max-w-5xl mx-auto mb-6 sm:mb-8 px-3 sm:px-4 py-3 border border-black/40 rounded-lg bg-white shadow-sm">
      ...
      <main className="max-w-5xl mx-auto space-y-5 sm:space-y-6 bg-white rounded-xl p-4 sm:p-6 md:p-8 shadow-md border border-black/40">
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-xs sm:text-sm text-black/70 mt-2 space-y-1">
        ...
        <section>
          <h2 className="text-lg sm:text-xl font-bold pt-3 sm:pt-4 border-t border-black/20 bg-clip-text text-transparent bg-linear-to-b from-amber-600 via-orange-600 to-red-600">
            2. Como Usamos suas Informações
          </h2>
        ...
        <section>
          ...
          <div className="mt-4 px-3 py-2 border-2 border-yellow-300 bg-yellow-100 rounded-md text-xs sm:text-sm font-semibold">
