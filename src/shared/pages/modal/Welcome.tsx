...
const Welcome = () => {
  ...
  return (
    <div className="min-h-screen max-w-full bg-linear-to-br from-orange-100 via-red-100 to-orange-100 flex items-center justify-center p-4 sm:p-6">
      <div className="bg-white border border-black/40 w-full sm:w-[90%] md:w-125 lg:w-150 h-auto rounded-lg p-4 sm:p-6 flex flex-col mx-auto">
        {/* - Título principal - */}

        <h1 className="font-semibold text-2xl sm:text-3xl text-black text-center py-3">
          Cadastro realizado com sucesso! 🎉
        </h1>
        <p className="text-base sm:text-lg text-black/60 mb-6 text-center">
        ...
        <button
          onClick={() => setScreen(2)}
          className="w-full h-10 bg-linear-to-r from-amber-600 via-orange-600 to-red-600 text-white font-semibold text-lg rounded-lg px-3 cursor-pointer hover:from-amber-400 hover:via-orange-400 hover:to-red-400 text-center border border-black/40"
        >
          Começar Agora
        </button>
      </div>
