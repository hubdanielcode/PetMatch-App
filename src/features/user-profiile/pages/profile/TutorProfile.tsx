  ...
  return (
    <div className="min-h-screen w-full bg-linear-to-br from-amber-100 via-orange-100 to-red-100">
      <div className="flex flex-col">
        <h1 className="text-black font-bold text-3xl pl-4 py-10 ml-[15%]">
          Meu Perfil
        </h1>
        ...
        <div className="flex h-fit w-[25%] bg-linear-to-br from-amber-300 via-orange-300 to-red-300 px-2 py-1 gap-1 ml-[15%] rounded-full justify-center text-black font-semibold text-sm">
          <button
            className={`rounded-full px-4 py-1 min-w-[50%] cursor-pointer ${activeTab === "Tutor" ? "bg-white border border-black/40" : "bg-transparent"}`}
          ...
          <button
            className={`rounded-full px-4 py-1 min-w-[50%] cursor-pointer ${activeTab === "Pet" ? "bg-white border border-black/40" : "bg-transparent"}`}
